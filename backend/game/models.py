...
class PlacedObject(models.Model):
    ...
    class Meta:
        verbose_name = "Placed Object"
        verbose_name_plural = "Placed Objects"
        indexes = [
...
class RateLimit(models.Model):
    ...
    def __str__(self):
        player_name = self.player.user.username if self.player else "Global"
        return f"{player_name} - {self.limit_type}: {self.count}"
...
class EraUnlock(models.Model):
    ...
    class Meta:
        verbose_name = "Era Unlock"
        verbose_name_plural = "Era Unlocks"
...
class UpgradeKey(models.Model):
    ...
    class Meta:
        verbose_name = "Upgrade Key"
        verbose_name_plural = "Upgrade Keys"
        indexes = [
